...
function renderCountryList(countries) {
    const markup = countries.map((country)=>`<li class="country-item">${country.name}</li>`).join("");
...
},{"lodash.debounce":"irvaP","./fetchCountries":"LnPoi","@pnotify/core":"fay4s","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
function fetchCountries(name) {
    return fetch(`https://restcountries.com/v2/name/${name}?fields=name,capital,population,languages,flag`).then((response)=>{
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}]},["6DHTQ","6kb64"], "6kb64", "parcelRequirec490", {})

//# sourceMappingURL=goit-js-hw-12-countries.6528c13b.js.map
